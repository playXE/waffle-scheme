...
pub type JITSig = extern "C" fn(&mut SchemeThread, trampoline: &mut Trampoline) -> Value;
...
impl MethodJIT {
    ...
    pub fn compile(&mut self, proto: Managed<ScmPrototype>, dump: bool) -> *const u8 {
        let lir = lower::lower(proto);

        {
            ...
            compiler.builder.declare_var(compiler.si, types::I64);
            compiler.blocks.insert(0, entry_block);
            compiler.translate(proto, thread, trampoline);
